...
![Travis status](https://travis-ci.org/ruby-processing/JRubyArt.svg) The travis build won't work until processing.org update their maven entry now using local jars for processing-3.0.2
