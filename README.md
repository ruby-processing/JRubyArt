...
See [alternative website](http://ruby-processing.github.io/) for versions before JRubyArt-1.2.0, if it matters to you download a copy soon because it will be replaced with learning JRubyArt content or similar...
