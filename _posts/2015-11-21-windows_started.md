...
Install [wget][wget] which is also available as [cygwin][cygwin] package, Oracle java (1.8.0.151+), and some version of ruby-2.2+ preferably jruby-9.1.16.0. NB: for jdk9 use propane-2.7.0+.
