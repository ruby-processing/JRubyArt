...
Install [wget][wget] which is also available as [cygwin][cygwin] package, openjdk (17.01+), and some version of ruby-2.6+ preferably jruby-9.3+. If you encounter linkage problems it might be worth looking at [Eclipse Temurin][adopt] distribution or OpenJ9.
