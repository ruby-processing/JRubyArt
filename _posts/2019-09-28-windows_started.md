...
Install [wget][wget] which is also available as [cygwin][cygwin] package, openjdk (11.0.3+), and some version of ruby-2.5+ preferably jruby-9.2+. If you encounter linkage problems it might be worth looking at [AdoptOpenJDK][adopt] distribution or OpenJ9.
