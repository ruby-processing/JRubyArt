...
[Sam Pottinger][sam] has created a version of vanilla processing that will run with jdk11, I would seriously recommend macOS users to use this for JRubyArt. It may require compiling and careful setting of `PROCESSING_ROOT`, otherwise try [propane][propane] instead.
