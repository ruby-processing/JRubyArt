...
Setting JRubyArt for the first time, can seem a bit involved (especially if you are addicted to rvm or rbenv). The JRubyArt gem relies on jruby-9.2++, processing-3.4.0, and a handful of other dependencies. Here's how to get them all installed and working on the Mac.
