...
Setting JRubyArt for the first time, can seem a bit involved (especially if you are addicted to rvm or rbenv). The JRubyArt gem relies on JRuby-9.1.6.0+, Processing-3.2.3, and a handful of other dependencies. Here's how to get them all installed and working on the Mac.
