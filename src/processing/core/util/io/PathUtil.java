...
public class PathUtil {
   ...
   * @return The extension of the file at path like "png" or "unknown" if could
   * not be determined.
   */
  ...
  /**
   * Clean up irregularities like leading period or capitalization from an
   * extension string.
   *
   ...
   *
   * @param path The path like folder1/folder2/image.png. In this example,
   * folder1 and folder2 would both be created if not already existing.
   */
   ...
   * folder1/folder2/image.png would cause folder1 and folder2 to be created if
