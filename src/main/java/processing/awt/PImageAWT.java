...
public class PImageAWT extends PImage {
     ...
     * save.Various formats are supported, typically jpeg, png, bmp, and wbmp.To
     * get a list of the supported formats for writing, use: <BR>
     * <b>println(javax.imageio.ImageIO.getReaderFormatNames())</b>
     *
     * @param path
     * @return
    ...
    protected boolean saveImageIO(String path) throws IOException {
        try {
            ...
            if (extension.equals("png") && (writer = imageioWriter("png")) != null) {
                    param = writer.getDefaultWriteParam();
                    if (false) {
