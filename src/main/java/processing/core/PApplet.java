...
//          event.getKeyCode() == 'W') {
 ...
 <A HREF="https://processing.org/reference/launch_.html">launch()</A>
   ...
   * output.
   * <br/><br/> <b>println()</b> on an array (by itself) will write the contents
...
//   */
 ...
 /*
   ...
   * interpreted as time.<br /><br />The actual noise is structured similar to
   ...
   * values returned by <b>noise()</b>.<br /><br
...
//  }
   ...
   * always be positive integers.<br /><br />As shown in the above example,
...
//  }
   ...
   * to reset the camera before applying transformations.<br /><br
   ...
   * not to assign it to an int value.<br /><br />The red() function is easy to
   ...
   * <b>colorMode()</b>. This value is always returned as a float so be careful
   * not to assign it to an int value.<br /><br />The <b>green()</b>
   ...
   * <b>colorMode()</b>. This value is always returned as a float so be careful
   * not to assign it to an int value.<br /><br />The <b>blue()</b>
   * function is easy to use and undestand, but is slower than another
   * technique. To achieve the same results when working in <b>colorMode(RGB,
   * 255)</b>, but with greater speed, use a bit mask to remove the other color
   * components. For example, the following two lines of code are    equivalent:<br /><pre>float r1 = blue(myColor);<br />float r2 = myColor
   * &amp; 0xFF;</pre>
   *
   * ( end auto-generated )
   *
