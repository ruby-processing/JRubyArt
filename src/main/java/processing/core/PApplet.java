...
//          event.getKeyCode() == 'W') {
 ...
 2004, 2005, etc). ( end auto-generated ) The <b>year()</b> function returns the current
 ...
 <A HREF="https://processing.org/reference/launch_.html">launch()</A>
  ...
  static private final String shellQuoted(String arg) {
    ...
    //////////////////////////////////////////////////////////////
    /**
     * Call a method in the current class based on its name.Note that the function being called must be public.
     *
     * Inside the PDE,
...
//    System.out.println("got " + variables.length + " variables");
 ...
 square root <b>s</b> of number <b>a</b> is such that <b>s*s = a</b>. It
     ...
     * number.This function expects the values greater than 0.0. ( end auto-generated )
     *
     * @return
     * @webref math:calculation
...
//   */
 ...
 returned in the range <b>-PI/2</b> to <b>PI/2</b>. ( end auto-generated )
     *
     * @return
     * @webref math:trigonometry
 ...
 function expects the values in the range of -1 to 1 and values are
 returned in the range <b>0</b> to <b>PI (3.1415927)</b>. ( end auto-generated )
     *
     * @return
     * @webref math:trigonometry
 ...
 10. ( end auto-generated )
     ...
     * of the parameter.( end auto-generated )
     *
     *
     * @return
     * @webref math:calculation
 ...
 example, <b>round(9.2)</b> returns the value 9. ( end auto-generated )
     *
     * @return
     * @webref math:calculation
...
//  }
    ...
    /**
     * Options may contain "header", "tsv", "csv", or "bin" separated by commas.Another option is "dictionary=filename.tsv", which allows users to
...
//    }
 ...
 (see above example). Starting with Processing release 0134, all files loaded and saved by the
 Processing API use UTF-8 encoding. In previous releases, the default
 encoding for your platform was used, which causes problems when files are
 moved to other platforms.
 ...
 ( end auto-generated )
     ...
     *
     * This is a function for advanced programmers to open a Java InputStream.It's useful if you want to use the facilities provided by PApplet to
 ...
 (and with less confusing syntax). When using the <b>targetFile</b> parameter, it writes to a <b>File</b>
     ...
     * greater control over the file location.Note that unlike other api methods, this will not automatically compress
 ...
 folder.Note that when running as an applet inside a web browser, the sketchPath
 will be set to null, because security restrictions prevent applets from
 accessing that information. This will also cause an error if the sketch is not inited properly,
 ...
 but creates any in-between folders so that things save properly.All saveXxxx() functions use the path to the sketch folder, rather than
...
//  }
 ...
 of the array. When using an array of objects, the data returned from the function must
 be cast to the object array's data type. For example: <em>SomeClass[]
     ...
     *
     * Decreases an array by one element and returns the shortened array.When using an array of objects, the data returned from the function must
 be cast to the object array's data type.
     *
     * For example: <em>SomeClass[]
 ...
 be cast to the object array's data type. For example: <em>SomeClass[]
     ...
     *
     * Reverses the order of an array.( end auto-generated )
     *
     *
     * @return
     * @webref data:array_functions
 ...
 return, and tab, this function also removes the Unicode "nbsp" character. ( end auto-generated )
     *
     * @return
 ...
 ints or floats, it's necessary to first convert them to strings using
    <b>nf()</b> or <b>nfs()</b>. ( end auto-generated )
     *
     * @return
     * @webref data:string_functions
     ...
     * characters to be used as a boundary.If no <b>tokens</b> character is specified, any whitespace character is
 used to split.
     *
 ...
 String can't be parsed as a number, it will be set to zero.String s[] = { "1", "300", "44" }; int numbers[] = parseInt(s);
 ...
 the value of the "missing" parameter.String s[] = { "1", "300", "apple", "44" }; int numbers[] = parseInt(s,
 9999);
 ...
 ( end auto-generated )
     ...
     * equivalent integer value.( end auto-generated )
     *
     *
     * @return
     * @webref data:conversion
 ...
 ( end auto-generated )
     ...
     * integer value.For example, unbinary("00001000") will return 8. ( end auto-generated )
     *
     * @return
     * @webref data:conversion
     * @param value String to convert to an integer
 ...
 therefore, the function call <b>color(255, 204, 0)</b> will return a
     ...
     *
     * Calculates a color or colors between two color at a specific increment.The <b>amt</b> parameter is the amount to interpolate between the two
...
//  }
 ...
 definition of <a href="http://en.wikipedia.org/wiki/Tangent"target="new"><em>tangent</em> on Wikipedia</a>. ( end auto-generated )
 ...
 of <em><a href="http://en.wikipedia.org/wiki/Tangent"target="new">tangent on Wikipedia</a>.</em> ( end auto-generated )
 ...
 example, adding the <b>textAscent()</b> and
     ...
     *
     * Calculates and returns the width of any character or text string.( end auto-generated )
     *
     *
     * @return
     * @webref typography:attributes
 ...
 point once the transformations are no longer in use. In the example, the <b>modelX()</b>, <b>modelY()</b>, and
     ...
     *
     * Extracts the alpha value from a color.( end auto-generated )
     *
     *
     * @return
     * @webref color:creating_reading
 ...
 use and understand, but is slower than another technique. To achieve the
