...
public class PImage implements PConstants, Cloneable {
  ...
  /**
   * @param width
   * @param height public PImage(int width, int height, int format, int factor)
   * { init(width, height, format, factor); }
   *
   * /**
   ...
   * constructor, or re-init later when things changes.Used by Capture and Movie
   * classes (and perhaps others), because the width/height will not be known
   * when super() is called.(Leave this public so that other libraries can do
   * the same.)
   *
   * @param width
   * @param height
   ...
   * <b>MODE</b> parameter.The possible modes are described in the reference for
   * the <b>blend()</b> function. ( end auto-generated )
   * <h3>Advanced</h3>
   * <UL>
