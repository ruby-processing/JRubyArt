...
Revert to Processing::Proxy as a module, but implement as :constant_missing, :method_missing (after tyfkda processing ruby-mode), require 'yaml' rather than 'psych' as workaround for builtin 'psych' in jruby.
